...
==== Documentation
- Untuk membuat dokumentasi haruslah menginstall Graphviz terlebih dahulu
untuk mac:
<tt>brew install Graphviz</tt>
untuk ubuntu:
<tt>sudo aptitude install graphviz</tt>
- Jalankan annotate untuk anotasi tabel ERD pada model
<tt>annotate</tt>
- Jalankan gem erd untuk generate erd
<tt>rake erd attributes=primary_keys,foreign_keys,content filetype=png filename=ERD</tt>
- Jalankan yard untuk mengenerate seluruh dokumentasi
<tt>yard</tt>
- Jalankan graph yard untuk generate UML
<tt>yard graph --full | dot -T png -o UML.png </tt>
- Dokumentasi berada di folder doc/index.html atau juga dapat dilihat dengan menjalankan
<tt>yard server</tt>
Dokumentasi akan muncul di localhost:8808

==== Menjalankan Test Suite
Aplikasi ini menggunakan RSpec untuk melakukan testing. Untuk melakukan testing, jalankan <tt>rspec</tt> di Terminal.
