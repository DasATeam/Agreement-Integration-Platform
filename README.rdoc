...
<tt>rake erd attributes=primary_keys,foreign_keys,content filetype=png filename=doc/ERD</tt>
- Terakhir jalankan yard untuk mengenerate seluruh dokumentasi
<tt>yard</tt>
- Jalankan graph yard untuk generate UML
<tt>yard graph --full | dot -T png -o doc/UML.png </tt>
- Dokumentasi berada di folder doc/index.html atau juga dapat dilihat dengan menjalankan
<tt>yard server</tt>
Dokumentasi akan muncul di localhost:8088
