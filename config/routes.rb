Rails.application.routes.draw do
  ...
  get 'merchant/details/:merchant_id/:agreement_channel_id' => 'agreement#custom_price'
  post 'merchant/details/:merchant_id/:agreement_channel_id' => 'agreement#change_price'
